...
const AboutUsPage = () => {
  ...
  const tabContent = {
    ...
    story: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">NextHire AI was inspired by real-life struggles with interview preparation. Abhishek set out to build a platform that makes interview prep simple, effective, and confidence-boosting for everyone. Our goal is to help you overcome the stress and uncertainty of interviews—so you can focus on showcasing your true potential.</p>
